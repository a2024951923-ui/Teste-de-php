...
<body>
    <div class="container">
        ...
        <form method="POST">
    <label>Nome:</label>
    <input type="text" name="nome" placeholder="Nome Completo do Professor" required>

    <label>E-mail:</label>
    <input type="email" name="email" placeholder="melhor.email@provedor.com" required> <!-- fantasma da caixa-->
